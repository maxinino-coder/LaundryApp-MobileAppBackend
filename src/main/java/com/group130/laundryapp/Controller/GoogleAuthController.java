...
public class GoogleAuthController {
    ...
    /**
     * Public origin of this backend, e.g. https://laundrygo.up.railway.app
     * Set via APP_PUBLIC_URL. Previously this was assembled from server.address
     * and server.port, which produced an unreachable http://localhost:8080
     * once the app was deployed behind a proxy.
     */
